...
export default function OfficerProfile() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const { data } = await axios.put("/officer/profile", form);
  ...
  if (!profile)
    return (
      <Container sx={{ py: 5 }}>
        <Alert severity="error">Officer profile not found.</Alert>
      </Container>
    );
      ...
      <Container maxWidth="lg" sx={{ py: 5 }}>
        ...
        >
          ...
          >
                  ...
                  onChange={async (e) => {
                    ...
                    try {
                      ...
                      if (data?.officer?.photo) {
                        ...
                        alert("⚠️ Uploaded but no file returned from server.");
                      }
                    } catch (err) {
            ...
            {user?.isVerified && (
              <Tooltip title="Verified Officer">
